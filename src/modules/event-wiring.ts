...
export interface EventWiringDeps {
    /** Live-getter object for mutable Three.js references */
    sceneRefs: {
        readonly scene: any;
        readonly camera: any;
        readonly controls: any;
        readonly splatMesh: any;
        readonly modelGroup: any;
        readonly pointcloudGroup: any;
        readonly flyControls: any;
        readonly ambientLight: any;
        readonly hemisphereLight: any;
        readonly directionalLight1: any;
        readonly directionalLight2: any;
    };
    state: any;
    sceneManager: any;
